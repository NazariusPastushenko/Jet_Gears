...
public partial class Search_By_Car_AutoZVUK : Form
{
        
    private Animation slideAnimation;
    private Timer animationTimer;
    private Point Current_Location = new Point(5, 5);
    public Search_By_Car_AutoZVUK()
    {
        InitializeComponent();
        Get_Makers();
    ...
    {
        Loading_Panel.Visible = true;              // показуємо індикатор
        Loading_Panel.BringToFront();              // виводимо на передній план
        ...
        try
        {
            ...
            if (makerNodes != null)
            {
                ...
                Write_Makers_Buttons(); // один раз після циклу
            }
        }
        catch
        {
        ...
        {
            Loading_Panel.Visible = false; // ховаємо індикатор у будь-якому випадку
        }
    }
    ...
    private void Get_Nodes(object sender, EventArgs e)
    {
        ImageTextButton b = sender as ImageTextButton;
        Clean_Buttons();
