...
public class OverviewPart
{
    ...
    public OverviewPart(string title, string description, string manufacturer, string article, string partPictureUrl, string price, List<KeyValuePair<string, string>> table)
    {
        Title = title;
